...
<body>
    <div class="container-fluid p-0 height">
        ...
        <div class="container " style="margin-top: 100px;" id="body-kho1">
            ...
            $id = $_GET['id'];
            ?>
            <form action="xu_ly_sua_kho1.php?id=<?php echo $id ?>" method="post">
                <?php
                $cnt = 1;
                $sql = "SELECT tblsanpham.id, tblsanpham.ten, tblsanpham.gia, 
                    tblsanpham.soluong, tblsanpham.donvi, tblloaisanpham.tenloai
                    FROM (tblsanpham
                    INNER JOIN tblloaisanpham ON tblsanpham.tblloaisanphamid =tblloaisanpham.id)
                    INNER JOIN tblkho ON tblkho.id = tblloaisanpham.tblkhoid
                ...
                ?>
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="tensp" placeholder="nhập tên sản phẩm" name="tensp" value="<?php echo $row["ten"]; ?>">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="giasp" class="form-label">giá sản phẩm:</label>
                            <input type="number" class="form-control" id="giasp" placeholder="nhập giá sản phẩm" name="giasp" value="<?php echo $row["gia"]; ?>">
                        </div>
                        
                        <div class="mb-3 mt-3">
                            <label for="soluongnhap" class="form-label">Số lượng</label>
                            <input type="number" class="form-control" id="soluongnhap" placeholder="Nhập số lượng " name="soluongnhap" value="<?php echo $row["soluong"]; ?>">
                        </div>

                        <div class="mb-3 mt-3">
                            <label for="donvi" class="form-label">Đơn vị</label>
                            <input type="text" class="form-control" id="donvi" placeholder="Nhập đơn vị " name="donvi" value="<?php echo $row["donvi"]; ?>">
                        </div>
