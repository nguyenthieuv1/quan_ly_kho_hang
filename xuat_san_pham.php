...
<body>
    <div class="container-fluid p-0 height">
        ...
        <div class="container " style="margin-top: 100px;" id="body-kho1">
            <h4 class="text-center">xuất sản phẩm trong kho trong kho</h4>
            <form action="xu_ly_xuat_san_pham.php" method="post">
                <div class="mb-3 mt-3">
                    <label for="tensp" class="form-label">Tên sản phẩm:</label>
                    <!-- <input type="text" class="form-control" id="tensp" placeholder="nhập tên sản phẩm" name="tensp"> -->
                    <select class="form-select" id="tensp" name="id">
                        <?php
                ...
                <div class="mb-3 mt-3">
                    <label for="soluongxuat" class="form-label">Số lượng</label>
                    <input type="number" class="form-control" id="soluongxuat" placeholder="Nhập số lượng " name="soluongxuat">
                </div>
