...
<body>
    <div class="container-fluid p-0 height">
        ...
        <div class="container" id="body-kho1">
            <h4 class="text-center" style="margin-top: 75px;">Danh sách phiếu xuất</h4>
            <table class="table text-center">
                ...
                <tbody>
                    ...
                    $cnt = 1;
                    $sql = "SELECT tblphieuxuat.id, tblphieuxuat.ngayxuat, tblsanpham.ten,
                    tblphieuxuat.soluongxuat, tblsanpham.gia, tblsanpham.donvi, tblloaisanpham.tenloai
                    FROM ( tblphieuxuat
                    INNER JOIN tblsanpham ON tblsanpham.id = tblphieuxuat.tblsanphamid)
                    INNER JOIN tblloaisanpham ON tblloaisanpham.id = tblsanpham.tblloaisanphamid ORDER BY tblphieuxuat.id desc
                    ";
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a class="btn btn-danger" href="delete_phieu_xuat.php?id=<?php echo $row["id"]; ?>">xóa</a></td>
                            </tr>
