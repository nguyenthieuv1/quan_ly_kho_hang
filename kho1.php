...
<body>
    <div class="container-fluid p-0 height overflow-y-scroll">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a class="btn btn-primary" href="sua_kho1.php?id=<?php echo $row["id"]; ?>">sửa</a></td>
                                <td><a href="delete_san_pham_kho1.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger">xóa</a></td>
                            </tr>
